package com.gdufs.securitydb.filter.qq;
...
import static com.gdufs.securitydb.filter.qq.QQAuthenticationFilter.clientId;

/**
 * QQAuthenticationManager 的作用是通过传来的 token 和 openID 去请求腾讯的getUserInfo接口，获取腾讯用户的信息，并生成新的 Authtication 对象。
 */
